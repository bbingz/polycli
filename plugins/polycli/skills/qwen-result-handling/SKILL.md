...
## For `polycli:polycli-provider-agent`
...
- If helper reports setup/authentication required, direct user to `/polycli:setup --provider qwen` and do not improvise alternate auth flows.
