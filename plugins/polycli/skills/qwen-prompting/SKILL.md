---
name: qwen-prompting
description: Internal guidance for composing Qwen Code prompts for coding, review, diagnosis, and research tasks inside the polycli Claude Code plugin
user-invocable: false
---

# Qwen Prompting(qwen3.5-plus 为默认模型;qwen3.6 要 Pro 订阅)

Use this skill when `polycli:polycli-provider-agent` needs to ask Qwen for help.
