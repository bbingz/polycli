...
argument-hint: '--provider <claude|copilot|opencode|pi|cmd|gemini|kimi|qwen|minimax|grok> [--model <model>] [--background] [--base <ref>] [--scope <auto|staged|unstaged|working-tree|branch>] [--max-diff-bytes <n>] [focus ...]'
