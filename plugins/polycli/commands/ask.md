...
argument-hint: '--provider <claude|copilot|opencode|pi|cmd|agy|gemini|kimi|qwen|minimax> [--model <model>] [--background] [--resume-last|--resume <uuid>|--fresh] [--write] [--effort low|medium|high] <prompt>'
