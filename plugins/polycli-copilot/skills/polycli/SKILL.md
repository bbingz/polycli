---
name: polycli
description: Run the shared polycli companion from this repository to inspect provider setup, ask questions, manage background jobs, and query timing history.
---
