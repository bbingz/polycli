...
As of `2026-05-30`, the current public patch release is:
...
- npm packages: publish of `0.6.19` is **PENDING `npm login`** (registry was logged out at release time). Last npm-published version: `@bbingz/polycli-opencode@0.6.18` and `@bbingz/polycli@0.6.18`. After `npm login`, run `npm publish ./plugins/polycli-opencode --access public` and `npm publish ./packages/polycli-terminal --access public`, then flip this line.
