...
- Published npm packages: `@bbingz/polycli-opencode@0.6.7` and `@bbingz/polycli@0.6.7` (terminal CLI, new in this release)
- Utility packages remain `@bbingz/polycli-utils@1.0.1` and `@bbingz/polycli-timing@1.0.1` (independent v1.x cadence; unchanged in v0.6.7)
