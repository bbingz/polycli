...
- **Investigate CLAUDE.md inheritance into polycli subagent.** Pilot showed native Agent responded in Chinese (inherited global CLAUDE.md) while polycli claude responded in English. Either polycli companion strips CLAUDE.md or runs in a different working dir. This is a confound for any byte-comparison bench and should be resolved before the formal bench runs.
